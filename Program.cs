...
namespace DIO.Series
{
    class Program
    {
        ...
        private static void AtualizarFilme()
		{
			...
			foreach (int i in Enum.GetValues(typeof(GeneroFilme)))
			{
				Console.WriteLine("{0}-{1}", i, Enum.GetName(typeof(GeneroFilme), i));
			}
			Console.Write("Digite o gênero entre as opções acima: ");
			int entradaGenero = int.Parse(Console.ReadLine());
			...
			Console.Write("Digite os Atores Principais do Filme: ");
			string entradaAtoresPrincipais = Console.ReadLine();
			...
			Filme atualizaFilme = new Filme(id: indiceFilme,
										...
										atoresprincipais: entradaAtoresPrincipais,
										ano: entradaAno,
										descricao: entradaDescricao);
